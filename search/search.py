...
def uniformCostSearch(problem):
    ...
    frontier.push(currState, problem.getCostOfActions(currState[1]))
    explored = set([]) #set of states
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    frontier = util.PriorityQueue()
    currState = (problem.getStartState(), [])
    currCost = heuristic(problem.getStartState(), problem)
 
    frontier.push(currState, problem.getCostOfActions(currState[1]) + currCost )
    explored = set([])
